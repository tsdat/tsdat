...
class DatasetDefinition:
    ...
    def _parse_attributes(self, dictionary: Dict, pipeline_type: str) -> Dict[str, Any]:
    ...
    def _parse_data_level(self, pipeline_type: str) -> str:
    ...
    def _add_autogenerated_attributes(self, attrs: Dict[str, Any], dictionary: Dict) -> Dict[str, Any]:
        """-------------------------------------------------------------------
        ...
        self.datastream     = attrs["datastream"]
    ...
    def _generate_datastream(self) -> str:
        loc_id      = self.attrs.get("location_id")
        instr_id    = self.attrs.get("instrument_id")
        qualifier   = self.attrs.get("qualifier", "")
        temporal    = self.attrs.get("temporal", "")
        data_level  = self.attrs.get("data_level")
    ...
    def _error_check_required_global_attrs(self):
        ...
        for attr_name in required_attrs:
            attr_value = self.attrs.get(attr_name, None)
    ...
    def add_input_files_attr(self, input_files: List[str]):
        ...
        self.attrs["input_files"] = _input_files
