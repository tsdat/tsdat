...
class IngestPipeline(Pipeline):       
    ...
    def run(self, filepath: str) -> None:
        ...
        # Fail if coordinate variables have critical errors
        # (default checks are monotonically increasing and
        # no missing values)
        self.validate_coordinate_variables(dataset)
        ...
        # Record any autogenerated global attributes (e.g., input_files)
        self.record_autogenerated_metadata(dataset, raw_dataset_mapping)
