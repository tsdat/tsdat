...
class _ADIBaseTransformer(DataConverter):
    ...
    _range: Optional[str] = Field(None, alias="range")
    ...
    def convert(
        ...
        **kwargs: Any,
        ...
        # TODO: Also pull in "local" configurations, e.g., parameters on 'self'
        # TODO: Support coord-dependent local config, e.g., {time: 300s, height: 5m}
