...
HUMBOLDT_FILE = os.path.join(_data_dir, "humboldt/buoy.z05.00.20201201.000000.imu.bin")

MORRO_CONFIG = os.path.join(_config_dir, "morro_config.yml")
MORRO_FILE = os.path.join(_data_dir, "morro/buoy.z06.00.20201201.000000.imu.bin")
