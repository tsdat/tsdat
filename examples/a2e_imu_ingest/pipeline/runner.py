...
def run_pipeline():
    ...
    humboldt_raw_file = os.path.join(data_dir, 'humboldt/buoy.z05.00.20201201.000000.imu.bin')
    ...
    morro_raw_file = os.path.join(data_dir, 'morro/buoy.z06.00.20201201.000000.imu.bin')
