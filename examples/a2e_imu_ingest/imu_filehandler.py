...
packet = {
    "header": {"sync1": UINT8, "sync2": UINT8, "max_packet_size": UINT8, "payload_size": UINT8},
    "gps_time": {"packet_descriptor": UINT8, "fdescriptor": UINT8, "tow": DOUBLE, "week_number": UINT16, "flag": UINT16},
    "rpy": {"packet_descriptor": UINT8, "fdescriptor": UINT8, "roll": SINGLE, "pitch": SINGLE, "yaw": SINGLE},
    "gyro": {"packet_descriptor": UINT8, "fdescriptor": UINT8, "x": SINGLE, "y": SINGLE, "z": SINGLE},
    "accel": {"packet_descriptor": UINT8, "fdescriptor": UINT8, "x": SINGLE, "y": SINGLE, "z": SINGLE},
    "mag": {"packet_descriptor": UINT8, "fdescriptor": UINT8, "x": SINGLE, "y": SINGLE, "z": SINGLE},
    "pressure": {"packet_descriptor": UINT8, "fdescriptor": UINT8, "data": SINGLE},
    "chksum": {"msb": UINT8, "lsb": UINT8}
}
# packet = {
#     "header": {"": UINT8, "": UINT8, "": UINT8, "": UINT8},
#     "gps_time": {"": UINT8, "": UINT8, "tow": DOUBLE, "week_number": UINT16, "flag": UINT16},
#     "rpy": {"": UINT8, "": UINT8, "roll": SINGLE, "pitch": SINGLE, "yaw": SINGLE},
#     "gyro": {"": UINT8, "": UINT8, "x": SINGLE, "y": SINGLE, "z": SINGLE},
#     "accel": {"": UINT8, "": UINT8, "x": SINGLE, "y": SINGLE, "z": SINGLE},
#     "mag": {"": UINT8, "": UINT8, "x": SINGLE, "y": SINGLE, "z": SINGLE},
#     "pressure": {"": UINT8, "": UINT8, "data": SINGLE},
#     "chksum": {"": UINT8, "": UINT8}
# }
...
class ImuFileHandler(AbstractFileHandler):
    ...
    def read(filename: str, **kwargs) -> xr.Dataset:
        ...
        raw_data = {category: {var_name: [] for var_name in subpacket.keys()}
        ...
        for i in range(len(time)):
            ...
            seconds = data["gps_time"]["tow"][i] - 18
        ...
        # rpy = np.array([data["rpy"]["roll"], data["rpy"]["pitch"], data["rpy"]["yaw"]]).transpose()
